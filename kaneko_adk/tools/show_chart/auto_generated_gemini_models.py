...
#   filename:  auto_generated_gemini_schema.json"""
...
class Format(BaseModel):
    type: Type = Field(
        ..., description="Type of input data. Only 'csv' is supported.")
...
class Data(BaseModel):
    ...
    url: str = Field(..., description='CSV file path')
...
class Model(BaseModel):
    ...
    mark: Mark = Field(..., description='All types of primitive marks.')
